...
namespace caffe {
	...
	template <typename Dtype>
	void GridLSTMUnitLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
	...
	template <typename Dtype>
	void GridLSTMUnitLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
	...
	INSTANTIATE_LAYER_GPU_FUNCS(GridLSTMUnitLayer);
