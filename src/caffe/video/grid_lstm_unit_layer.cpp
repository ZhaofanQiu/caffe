...
namespace caffe {
	...
	template <typename Dtype>
	void GridLSTMUnitLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
	...
	template <typename Dtype>
	void GridLSTMUnitLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top) {
	...
	template <typename Dtype>
	void GridLSTMUnitLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
	STUB_GPU(GridLSTMUnitLayer);
#endif

	INSTANTIATE_CLASS(GridLSTMUnitLayer);
	REGISTER_LAYER_CLASS(GridLSTMUnit);
}  // namespace caffe